...
# from models_with_trn import TSN
...
parser.add_argument('dataset', type=str, choices=['something','jester','moments','charades', 'ucf101', 'hmdb51', 'kinetics', 'egok360'])
parser.add_argument('modality', type=str, choices=['RGB', 'Flow', 'RGBDiff'])
parser.add_argument('test_list', type=str)
parser.add_argument('weights', type=str)
parser.add_argument('--arch', type=str, default="resnet101")
parser.add_argument('--save_scores', type=str, default=None)
parser.add_argument('--test_segments', type=int, default=3)  # default is 25
parser.add_argument('--test_faces', type=int, default=20)
parser.add_argument('--max_num', type=int, default=-1)
parser.add_argument('--test_crops', type=int, default=1)  # [1, 10]
...
file_categories = "/data/cuiyujie/data/EgoK360_list/class_list.txt"
with open(file_categories) as f:
    lines = f.readlines()
categories = [item.rstrip() for item in lines]
num_class = 63

net = TSN(num_class, args.test_segments if args.crop_fusion_type in ['TRN','TRNmultiscale'] else 1, args.test_faces,
          args.modality,
...
data_loader = torch.utils.data.DataLoader(
        TangentDataSet(args.test_list, num_segments = args.test_segments,
...
for i, (data, label) in data_gen:
    ...
    print('video {} done, total {}/{}, average {:.3f} sec/video, moving Prec@1 {:.3f} Prec@5 {:.3f}'.format(i, i+1, total_num, float(cnt_time) / (i+1), top1.avg, top5.avg))
